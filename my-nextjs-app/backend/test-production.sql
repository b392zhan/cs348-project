...
SELECT b.book_id, b.title, b.issue, b.page_length, GROUP_CONCAT(DISTINCT a.name SEPARATOR ', ') AS authors, b.cover_url
FROM Book b
LEFT JOIN WrittenBy wb ON b.book_id = wb.book_id
LEFT JOIN Author a ON wb.author_id = a.author_id
WHERE b.title LIKE "%My Book Cover%"
...
VALUES ("The Great Gatsby", "3rd Edition", 180, "https://example.com/covers/great-gatsby.jpg");
...
-- R9 - Star a Book
INSERT INTO HasStarred (user_id, book_id, starred) 
VALUES (999, 456, TRUE);
...
SELECT b.book_id, b.title, b.issue, b.page_length, b.cover_url, GROUP_CONCAT(DISTINCT a.name SEPARATOR ', ') AS authors
FROM Book b
LEFT JOIN WrittenBy wb ON b.book_id = wb.book_id
LEFT JOIN Author a ON wb.author_id = a.author_id
WHERE b.page_length BETWEEN 1 AND 101
GROUP BY b.book_id
